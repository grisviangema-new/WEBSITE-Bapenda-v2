...
const News = () => {
    ...
    // State untuk mengatur jumlah berita yang ditampilkan (Default 9)
    ...
    // Fungsi untuk menampilkan seluruh berita
    const handleShowAll = () => {
            ...
            <div className='max-w-7xl mx-auto'>
                ...
                {newsList.length === 0 ? (
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
                        {/* Menggunakan slice untuk membatasi tampilan sesuai visibleCount */}
                ...
                {/* --- TOMBOL LIHAT SEMUA --- */}
                {/* Hanya muncul jika jumlah berita > visibleCount (belum ditampilkan semua) */}
                {newsList.length > visibleCount && (
                    <div className='text-center mt-12'>
                        <button 
                            onClick={handleShowAll}
                            className='px-8 py-3 border border-blue-600 text-blue-600 rounded-full font-semibold hover:bg-blue-600 hover:text-white transition-all duration-300 shadow-sm hover:shadow-md'
                        >
                            Lihat Semua Berita ({newsList.length - visibleCount} lagi)
                        </button>
                    </div>
                )}
            </div>
