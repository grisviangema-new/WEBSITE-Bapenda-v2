                ...
                {petugas.length === 0 ? (
                    ...
                    <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8'>
                        ...
                        {petugas.slice(0, 8).map((item, index) => (
                            <div 
                                key={index}
                                // MENGHAPUS onClick dan cursor-pointer agar tidak bisa diklik
                                className='group bg-white rounded-3xl overflow-hidden shadow-sm border border-gray-100 flex flex-col relative'
                            >
                                {/* Foto Profil */}
                                <div className='relative aspect-[4/5] overflow-hidden bg-gray-100'>
                                    ...
                                    <div className='absolute bottom-0 left-0 right-0 p-6 text-white transform translate-y-2 group-hover:translate-y-0 transition-transform duration-300'>
                                        ...
                                        <p className='text-blue-200 font-medium text-sm uppercase tracking-wide mb-3 drop-shadow-sm line-clamp-2'>
                                            {item.jabatan}
                                        </p>
                                ...
                                {/* Informasi Tambahan (Hanya Wilayah, Tombol Lihat Profil Dihapus) */}
